...
@Component({
  selector: 'app-microsoftpricesection3',
  templateUrl: './microsoftpricesection3.component.html',
  styleUrls: ['./microsoftpricesection3.component.css']
})
export class Microsoftpricesection3Component implements OnInit {
