...
@Component({
  selector: 'app-microsoftpricesection5',
  templateUrl: './microsoftpricesection5.component.html',
  styleUrls: ['./microsoftpricesection5.component.css']
})
export class Microsoftpricesection5Component implements OnInit {
