...
@Component({
  selector: 'app-graebertpricesection4',
  templateUrl: './graebertpricesection4.component.html',
  styleUrls: ['./graebertpricesection4.component.css']
})
export class Graebertpricesection4Component implements OnInit {
