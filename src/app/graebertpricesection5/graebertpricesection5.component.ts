...
@Component({
  selector: 'app-graebertpricesection5',
  templateUrl: './graebertpricesection5.component.html',
  styleUrls: ['./graebertpricesection5.component.css']
})
export class Graebertpricesection5Component implements OnInit {
