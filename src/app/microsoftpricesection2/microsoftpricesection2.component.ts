...
@Component({
  selector: 'app-microsoftpricesection2',
  templateUrl: './microsoftpricesection2.component.html',
  styleUrls: ['./microsoftpricesection2.component.css']
})
export class Microsoftpricesection2Component implements OnInit {
